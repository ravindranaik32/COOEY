...
public class BleDeviceAdapter extends ArrayAdapter {
	...
	public BleDeviceAdapter(Context context, ArrayList<BleDevice> modelsArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(modelsArrayList.size()!=0)
        {
              ...
              TextView nameView = (TextView) rowView.findViewById(R.id.s_NameTextView);
              TextView addressView=(TextView) rowView.findViewById(R.id.s_AddressTextView);
              ...
              else pairView.setText("NormalStatus");
        }
